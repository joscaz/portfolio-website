  ...
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        ...
        <li>Bachelor of Science - BS, Computer Science and Technology</li>
      </ul>
    ),
  },
  {
    ...
    content: (
      <ul className="list-disc pl-2">
        <li>QPR Suicide Prevention Gatekeeper Program</li>
        <li>How to collaborate with Github? Workshop</li>
        <li>ICPC Training Camp 2022</li>
      </ul>
    ),
  },
];
